...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="js/m2m_locDetails.js"></script>
	</head>
	<body onLoad="initialize()">
		...
		<div class="container">
			...
			<div class="row">
				<div class="span12">
					<h2>M2M Location: <span id="locationName"></span></h2>
					<p></p>
				</div>
				<div id="deviceList" class="span12">

				</div>
				<div id="graphList" class="span12">
